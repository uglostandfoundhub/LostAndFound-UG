        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Building = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationQuestion = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_AspNetUsers_ReportedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationAnswer = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    SupportingDetails = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItemClaims_AspNetUsers_ReviewedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemClaims_ItemId_ClaimantId",
                table: "ItemClaims",
                columns: new[] { "ItemId", "ClaimantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItemClaims_ReviewedById",
                table: "ItemClaims",
                column: "ReviewedById");
